		    ...
		    % \usepackage[dvips]{graphicx}
			  ...
			  % and their extensions so you won't have to specify these with
			    % every instance of \includegraphics
			      ...
			      \author{Levin~Halim,~\IEEEmembership{Department of Mechatronics Engineering,~Parahyangan Catholic University,}
			              and~Oetomo~Sudjana,~\IEEEmembership{Department of Mechatronics Engineering,~Parahyangan Catholic University}% <-this % stops a space
					      }
