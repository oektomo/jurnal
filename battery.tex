		    ...
		    % \usepackage[dvips]{graphicx}
			  ...
			  % and their extensions so you won't have to specify these with
			    % every instance of \includegraphics
			      ...
			      \author{Oetomo~Sudjana,~\IEEEmembership{Departement of Mechatronics Engineering, ~ Parahyangan Catholic University,}
			              Levin~Halim,~\IEEEmembership{Departement of Mechatronics Engineering, ~ Parahyangan Catholic University}% <-this % stops a space
			              
					      \thanks{S. Oetomo is with the Department
					      of Mechatronics Engineering, Parahyangan Catholic University, Bandung,
					      Bdg, 30332 INA e-mail: (oetomo@unpar.ac.id).}% <-this % stops a space
					      \thanks{H. Levin is with the Department
					      of Mechatronics Engineering, Parahyangan Catholic University, Bandung,
					      Bdg, 30332 INA e-mail: (halimlevin@unpar.ac.id).}% <-this % stops a space
					      ...
					      % problem
					      % design Flocking protocol with Ad-hoc communication
					      ...
					      % Adjacency matrix for Client Server Communication
					      % draw state-machine relation from example Ad-hoc communication
					      To implement network connection, we use Ad-Hoc network
					      \subsection{Mobile Robot Kinematics}
					      % Reverse and Forward kinematics from mobile robot
					      % Saturation problem
